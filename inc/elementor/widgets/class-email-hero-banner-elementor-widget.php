...
class Softro_Email_Hero_Banner_Widget extends Widget_Base
{

    public function get_name()
    {
        return 'gc_email_hero_banner';
    }

    public function get_title()
    {
        return esc_html__('GC Email Hero Banner', 'softro-core');
    }
    ...
    private function render_platform_icon(array $item, array $settings)
    {
        ...
        if (!$icon_url) {
            $icon_url = $this->get_media_url($settings['gc_email_hb_default_platform_icon_image'] ?? [], '');
        }
        ...
        if (!empty($settings['gc_email_hb_default_platform_icon']['value'])) {
            $this->render_icon($settings['gc_email_hb_default_platform_icon'], ['aria-hidden' => 'true']);
        }
    }
    ...
    private function get_default_chart_bars()
    {
        return [
            ['bar_height' => 38],
            ['bar_height' => 55],
    ...
    {
        $this->start_controls_section('gc_email_hb_shapes_section', [
            'label' => esc_html__('Decorative Shapes', 'softro-core'),
        ]);

        $this->add_control('gc_email_hb_bg_shape', [
            'label'       => esc_html__('Background Shape', 'softro-core'),
            'type'        => Controls_Manager::MEDIA,
            'media_types' => ['image'],
        ]);

        $this->add_control('gc_email_hb_bg_shape_fallback', [
            'type'    => Controls_Manager::HIDDEN,
            'default' => 'new-update/hero-shape-1.png',
        ]);

        $this->add_control('gc_email_hb_bg_shape_alt', [
        ...
        $this->add_control('gc_email_hb_shape_1', [
            'label'       => esc_html__('Shape 1', 'softro-core'),
            'type'        => Controls_Manager::MEDIA,
            'media_types' => ['image'],
        ]);

        $this->add_control('gc_email_hb_shape_1_fallback', [
            'type'    => Controls_Manager::HIDDEN,
            'default' => 'new-update/hero-shape-22.png',
        ]);

        $this->add_control('gc_email_hb_shape_2', [
            'label'       => esc_html__('Shape 2', 'softro-core'),
            'type'        => Controls_Manager::MEDIA,
            'media_types' => ['image'],
        ]);

        $this->add_control('gc_email_hb_shape_2_fallback', [
            'type'    => Controls_Manager::HIDDEN,
            'default' => 'new-update/hero-shape-3.png',
        ]);

        $this->add_control('gc_email_hb_shape_2_alt', [
        ...
        $this->start_controls_section('gc_email_hb_hero_section', [
            'label' => esc_html__('Hero Content', 'softro-core'),
        ]);

        $this->add_control('gc_email_hb_eyebrow', [
            'label'       => esc_html__('Eyebrow', 'softro-core'),
            'type'        => Controls_Manager::TEXT,
            'default'     => esc_html__('Email Marketing Solutions', 'softro-core'),
            'label_block' => true,
        ]);

        $this->add_control('gc_email_hb_title', [
            'label'       => esc_html__('Title', 'softro-core'),
            'type'        => Controls_Manager::TEXTAREA,
            'default'     => esc_html__('AI-Powered Email Marketing Service | Drive More Leads and Sales', 'softro-core'),
            'label_block' => true,
            'rows'        => 3,
        ]);

        $this->add_control('gc_email_hb_description', [
            'label'   => esc_html__('Description', 'softro-core'),
            'type'    => Controls_Manager::WYSIWYG,
            'default' => esc_html__(
                'Our AI-driven email marketing solution increases sales, builds customer relationships, saves time, sends bulk emails to targeted audiences, responds with AI automation, and more. Grow your business with us.',
                'softro-core'
            ),
        ]);
        ...
        $this->start_controls_section('gc_email_hb_platform_defaults', [
            'label' => esc_html__('Platform Icon Defaults', 'softro-core'),
        ]);

        $this->add_control('gc_email_hb_platforms_aria_label', [
        ...
        $this->add_control('gc_email_hb_default_platform_icon', [
            'label'   => esc_html__('Default Platform Icon', 'softro-core'),
            'type'    => Controls_Manager::ICONS,
            'default' => ['value' => 'fa-brands fa-google', 'library' => 'fa-brands'],
        ]);

        $this->add_control('gc_email_hb_default_platform_icon_image', [
        ...
        $this->start_controls_section('gc_email_hb_platforms_section', [
            'label' => esc_html__('Platforms', 'softro-core'),
        ]);

        $this->add_control('gc_email_hb_platforms', [
        ...
        $this->start_controls_section('gc_email_hb_buttons_section', [
            'label' => esc_html__('Buttons', 'softro-core'),
        ]);

        $this->add_control('gc_email_hb_primary_button_text', [
        ...
        $this->add_control('gc_email_hb_primary_button_link', [
        ...
        $this->add_control('gc_email_hb_secondary_button_text', [
        ...
        $this->add_control('gc_email_hb_secondary_button_link', [
        ...
        $this->start_controls_section('gc_email_hb_dashboard_section', [
            'label' => esc_html__('Dashboard Card', 'softro-core'),
        ]);

        $this->add_control('gc_email_hb_dashboard_aria_label', [
        ...
        $this->add_control('gc_email_hb_dashboard_title', [
        ...
        $this->add_control('gc_email_hb_dashboard_status', [
        ...
        $this->add_control('gc_email_hb_metrics', [
        ...
        $bar_repeater = new Repeater();

        $bar_repeater->add_control('bar_height', [
            'label'   => esc_html__('Bar Height (%)', 'softro-core'),
            'type'    => Controls_Manager::NUMBER,
            'default' => 50,
            'min'     => 0,
            'max'     => 100,
        ...
        $this->add_control('gc_email_hb_chart_bars', [
            'label'       => esc_html__('Performance Chart Bars', 'softro-core'),
            'type'        => Controls_Manager::REPEATER,
            'fields'      => $bar_repeater->get_controls(),
            'default'     => $this->get_default_chart_bars(),
            'title_field' => '{{{ bar_height }}}%',
            'separator'   => 'before',
        ]);
    ...
    {
        $this->start_controls_section('gc_email_hb_style_layout', [
            'label' => esc_html__('Layout', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_control('gc_email_hb_reset_elementor_spacing', [
        ...
        $this->start_controls_section('gc_email_hb_style_section', [
            'label' => esc_html__('Section', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_group_control(Group_Control_Background::get_type(), [
            'name'     => 'gc_email_hb_section_background',
            'types'    => ['classic', 'gradient'],
            'selector' => '{{WRAPPER}} .gc-ppc-roi-section',
        ]);

        $this->add_responsive_control('gc_email_hb_section_padding', [
        ...
        $this->add_responsive_control('gc_email_hb_section_margin', [
        ...
        $this->start_controls_section('gc_email_hb_style_shapes', [
            'label' => esc_html__('Shape Images', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_responsive_control('gc_email_hb_bg_shape_width', [
        ...
        $this->add_responsive_control('gc_email_hb_shape_1_width', [
        ...
        $this->add_responsive_control('gc_email_hb_shape_2_width', [
        ...
        $this->start_controls_section('gc_email_hb_style_hero_content', [
            'label' => esc_html__('Hero Content', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_responsive_control('gc_email_hb_hero_content_padding', [
            'label'      => esc_html__('Padding', 'softro-core'),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em'],
        ...
        $this->add_responsive_control('gc_email_hb_hero_content_margin', [
            'label'      => esc_html__('Margin', 'softro-core'),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em'],
        ...
        $this->start_controls_section('gc_email_hb_style_title', [
            'label' => esc_html__('Title', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_group_control(Group_Control_Typography::get_type(), [
            'name'     => 'gc_email_hb_title_typography',
            'selector' => '{{WRAPPER}} .gc-ppc-hero-title',
        ]);

        $this->add_control('gc_email_hb_title_color', [
            'label'     => esc_html__('Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .gc-ppc-hero-title' => 'color: {{VALUE}};'],
        ]);

        $this->add_control('gc_email_hb_title_underline_color', [
            'label'     => esc_html__('Underline Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .gc-ppc-hero-title::after' => 'background-color: {{VALUE}};'],
        ]);

        $this->add_responsive_control('gc_email_hb_title_margin', [
            'label'      => esc_html__('Margin', 'softro-core'),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em'],
        ...
        $this->add_responsive_control('gc_email_hb_title_padding', [
            'label'      => esc_html__('Padding', 'softro-core'),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em'],
        ...
        $this->start_controls_section('gc_email_hb_style_desc', [
            'label' => esc_html__('Description', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_group_control(Group_Control_Typography::get_type(), [
            'name'     => 'gc_email_hb_desc_typography',
            'selector' => '{{WRAPPER}} .gc-ppc-hero-desc',
        ]);

        $this->add_control('gc_email_hb_desc_color', [
            'label'     => esc_html__('Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .gc-ppc-hero-desc' => 'color: {{VALUE}};'],
        ]);

        $this->add_responsive_control('gc_email_hb_desc_margin', [
            'label'      => esc_html__('Margin', 'softro-core'),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em'],
        ...
        $this->add_responsive_control('gc_email_hb_desc_padding', [
            'label'      => esc_html__('Padding', 'softro-core'),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em'],
        ...
        $this->start_controls_section('gc_email_hb_style_platforms', [
            'label' => esc_html__('Platforms List', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_responsive_control('gc_email_hb_platforms_gap', [
        ...
        $this->add_responsive_control('gc_email_hb_platforms_margin', [
            'label'      => esc_html__('Margin', 'softro-core'),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em'],
        ...
        $this->start_controls_section('gc_email_hb_style_platform_icon', [
            'label' => esc_html__('Platform Icon', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_responsive_control('gc_email_hb_platform_icon_size', [
        ...
        $this->add_control('gc_email_hb_platform_icon_color', [
        ...
        $this->start_controls_section('gc_email_hb_style_buttons_wrap', [
            'label' => esc_html__('Buttons Wrap', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_responsive_control('gc_email_hb_buttons_gap', [
            'label'      => esc_html__('Gap', 'softro-core'),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => ['px'],
        ...
        $this->add_responsive_control('gc_email_hb_buttons_margin', [
            'label'      => esc_html__('Margin', 'softro-core'),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em'],
        ...
        $this->start_controls_section('gc_email_hb_style_dashboard_wrap', [
            'label' => esc_html__('Dashboard Wrap', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_responsive_control('gc_email_hb_dashboard_max_width', [
            'label'      => esc_html__('Max Width', 'softro-core'),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => ['px', '%'],
            'selectors'  => ['{{WRAPPER}} .gc-ppc-dashboard-wrap.gc-email-dashboard-pro' => 'max-width: {{SIZE}}{{UNIT}};'],
        ]);

        $this->add_responsive_control('gc_email_hb_dashboard_wrap_margin', [
            'label'      => esc_html__('Margin', 'softro-core'),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em'],
            'selectors'  => ['{{WRAPPER}} .gc-ppc-dashboard-wrap.gc-email-dashboard-pro' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'],
        ]);

        $this->end_controls_section();

        $this->start_controls_section('gc_email_hb_style_dashboard_card', [
            'label' => esc_html__('Dashboard Card', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_group_control(Group_Control_Background::get_type(), [
            'name'     => 'gc_email_hb_dashboard_card_background',
            'types'    => ['classic', 'gradient'],
            'selector' => '{{WRAPPER}} .gc-ppc-dashboard-card',
        ]);

        $this->add_group_control(Group_Control_Border::get_type(), [
            'name'     => 'gc_email_hb_dashboard_card_border',
            'selector' => '{{WRAPPER}} .gc-ppc-dashboard-card',
        ]);

        $this->add_responsive_control('gc_email_hb_dashboard_card_radius', [
        ...
        $this->add_responsive_control('gc_email_hb_dashboard_card_padding', [
            'label'      => esc_html__('Padding', 'softro-core'),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em'],
        ...
        $this->start_controls_section('gc_email_hb_style_dashboard_title', [
            'label' => esc_html__('Dashboard Title', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_group_control(Group_Control_Typography::get_type(), [
            'name'     => 'gc_email_hb_dashboard_title_typography',
            'selector' => '{{WRAPPER}} .gc-ppc-dashboard-title',
        ]);

        $this->add_control('gc_email_hb_dashboard_title_color', [
            'label'     => esc_html__('Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .gc-ppc-dashboard-title' => 'color: {{VALUE}};'],
        ]);

        $this->add_control('gc_email_hb_dashboard_live_color', [
        ...
        $this->start_controls_section('gc_email_hb_style_dashboard_status', [
            'label' => esc_html__('Dashboard Status', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_group_control(Group_Control_Typography::get_type(), [
            'name'     => 'gc_email_hb_dashboard_status_typography',
            'selector' => '{{WRAPPER}} .gc-ppc-dashboard-status',
        ]);

        $this->add_control('gc_email_hb_dashboard_status_color', [
            'label'     => esc_html__('Text Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .gc-ppc-dashboard-status' => 'color: {{VALUE}};'],
        ]);

        $this->add_control('gc_email_hb_dashboard_status_bg', [
            'label'     => esc_html__('Background', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .gc-ppc-dashboard-status' => 'background-color: {{VALUE}};'],
        ]);

        $this->add_control('gc_email_hb_dashboard_status_border', [
            'label'     => esc_html__('Border Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
        ...
        $this->start_controls_section('gc_email_hb_style_metric', [
            'label' => esc_html__('Metrics', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_group_control(Group_Control_Typography::get_type(), [
            'name'     => 'gc_email_hb_metric_label_typography',
            'label'    => esc_html__('Label Typography', 'softro-core'),
            'selector' => '{{WRAPPER}} .gc-ppc-metric-label',
        ]);

        $this->add_control('gc_email_hb_metric_label_color', [
        ...
        $this->start_controls_section('gc_email_hb_style_chart', [
            'label' => esc_html__('Performance Chart', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_responsive_control('gc_email_hb_chart_visual_height', [
            'label'      => esc_html__('Chart Height', 'softro-core'),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => ['px'],
            'range'      => ['px' => ['min' => 80, 'max' => 300]],
            'selectors'  => ['{{WRAPPER}} .gc-email-dashboard-pro-visual' => 'height: {{SIZE}}{{UNIT}};'],
        ]);

        $this->add_responsive_control('gc_email_hb_chart_visual_margin', [
            'label'      => esc_html__('Chart Margin', 'softro-core'),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em'],
            'selectors'  => ['{{WRAPPER}} .gc-email-dashboard-pro-visual' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'],
        ]);

        $this->add_responsive_control('gc_email_hb_chart_visual_padding', [
            'label'      => esc_html__('Chart Padding', 'softro-core'),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em'],
            'selectors'  => ['{{WRAPPER}} .gc-email-dashboard-pro-visual' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'],
        ]);

        $this->add_responsive_control('gc_email_hb_chart_bar_gap', [
            'label'      => esc_html__('Bar Gap', 'softro-core'),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => ['px'],
            'selectors'  => ['{{WRAPPER}} .gc-email-dashboard-pro-bars' => 'gap: {{SIZE}}{{UNIT}};'],
        ]);

        $this->add_responsive_control('gc_email_hb_chart_bar_width', [
            'label'      => esc_html__('Bar Width', 'softro-core'),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => ['px', '%'],
            'selectors'  => ['{{WRAPPER}} .gc-email-dashboard-pro-bars span' => 'width: {{SIZE}}{{UNIT}};'],
        ]);

        $this->add_control('gc_email_hb_chart_bar_color_odd', [
            'label'     => esc_html__('Bar Color (Odd)', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .gc-email-dashboard-pro-bars span:nth-child(odd)' => 'background: {{VALUE}};'],
        ]);

        $this->add_control('gc_email_hb_chart_bar_color_even', [
            'label'     => esc_html__('Bar Color (Even)', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .gc-email-dashboard-pro-bars span:not(:nth-child(odd))' => 'background: {{VALUE}};'],
        ]);

        $this->add_control('gc_email_hb_chart_glow_color', [
            'label'     => esc_html__('Glow Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .gc-email-dashboard-pro-glow' => 'background: radial-gradient(circle at 50% 42%, {{VALUE}} 0%, transparent 70%);'],
        ]);
    ...
    {
        $this->start_controls_section('gc_email_hb_style_theme_mode', [
            'label' => esc_html__('Dark / Light Mode Colors', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->start_controls_tabs('gc_email_hb_theme_mode_tabs');

        $this->start_controls_tab('gc_email_hb_dark_tab', ['label' => esc_html__('Dark Mode', 'softro-core')]);

        $this->add_group_control(Group_Control_Background::get_type(), [
            'name'     => 'gc_email_hb_dark_section_bg',
            'label'    => esc_html__('Section Background', 'softro-core'),
            'types'    => ['classic', 'gradient'],
            'selector' => '[data-theme=dark] {{WRAPPER}} .gc-ppc-roi-section',
        ]);

        $this->add_control('gc_email_hb_dark_eyebrow_color', [
        ...
        $this->add_control('gc_email_hb_dark_platform_bg', [
        ...
        $this->add_control('gc_email_hb_dark_platform_border', [
        ...
        $this->add_control('gc_email_hb_dark_platform_icon_color', [
        ...
        $this->add_control('gc_email_hb_dark_primary_btn_color', [
        ...
        $this->add_control('gc_email_hb_dark_primary_btn_bg', [
        ...
        $this->add_control('gc_email_hb_dark_outline_btn_color', [
        ...
        $this->add_control('gc_email_hb_dark_outline_btn_border', [
        ...
        $this->add_control('gc_email_hb_dark_dashboard_card_bg', [
        ...
        $this->add_control('gc_email_hb_dark_dashboard_card_border', [
        ...
        $this->add_control('gc_email_hb_dark_dashboard_title_color', [
        ...
        $this->add_control('gc_email_hb_dark_dashboard_status_color', [
        ...
        $this->add_control('gc_email_hb_dark_metric_label_color', [
        ...
        $this->add_control('gc_email_hb_dark_metric_value_color', [
        ...
        $this->add_control('gc_email_hb_dark_chart_bar_odd', [
            'label'     => esc_html__('Chart Bar (Odd)', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('dark', ['.gc-email-dashboard-pro-bars span:nth-child(odd)' => 'background: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_dark_chart_bar_even', [
            'label'     => esc_html__('Chart Bar (Even)', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('dark', ['.gc-email-dashboard-pro-bars span:not(:nth-child(odd))' => 'background: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_dark_chart_glow', [
            'label'     => esc_html__('Chart Glow', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('dark', ['.gc-email-dashboard-pro-glow' => 'background: radial-gradient(circle at 50% 42%, {{VALUE}} 0%, transparent 70%);']),
        ]);

        $this->end_controls_tab();

        $this->start_controls_tab('gc_email_hb_light_tab', ['label' => esc_html__('Light Mode', 'softro-core')]);

        $this->add_group_control(Group_Control_Background::get_type(), [
            'name'     => 'gc_email_hb_light_section_bg',
            'label'    => esc_html__('Section Background', 'softro-core'),
            'types'    => ['classic', 'gradient'],
            'selector' => '[data-theme=light] {{WRAPPER}} .gc-ppc-roi-section',
        ]);

        $this->add_control('gc_email_hb_light_eyebrow_color', [
            'label'     => esc_html__('Eyebrow Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('light', ['.gc-ppc-roi-section .gc-hero-eyebrow' => 'color: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_light_title_color', [
            'label'     => esc_html__('Title Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('light', ['.gc-ppc-hero-title' => 'color: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_light_desc_color', [
            'label'     => esc_html__('Description Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('light', ['.gc-ppc-hero-desc' => 'color: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_light_platform_color', [
            'label'     => esc_html__('Platform Text Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('light', ['.gc-ppc-platforms li' => 'color: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_light_platform_bg', [
            'label'     => esc_html__('Platform Background', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('light', ['.gc-ppc-platforms li' => 'background-color: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_light_platform_border', [
            'label'     => esc_html__('Platform Border', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('light', ['.gc-ppc-platforms li' => 'border-color: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_light_platform_icon_color', [
            'label'     => esc_html__('Platform Icon Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
        ...
        $this->add_control('gc_email_hb_light_outline_btn_color', [
            'label'     => esc_html__('Outline Button Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('light', ['.gc-ppc-roi-section .gc-hero-btn-outline' => 'color: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_light_outline_btn_border', [
            'label'     => esc_html__('Outline Button Border', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('light', ['.gc-ppc-roi-section .gc-hero-btn-outline' => 'border-color: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_light_dashboard_card_bg', [
            'label'     => esc_html__('Dashboard Card Background', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('light', ['.gc-ppc-dashboard-card' => 'background-color: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_light_dashboard_card_border', [
            'label'     => esc_html__('Dashboard Card Border', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('light', ['.gc-ppc-dashboard-card' => 'border-color: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_light_dashboard_title_color', [
            'label'     => esc_html__('Dashboard Title Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('light', ['.gc-ppc-dashboard-title' => 'color: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_light_dashboard_status_color', [
            'label'     => esc_html__('Status Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('light', ['.gc-ppc-dashboard-status' => 'color: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_light_metric_label_color', [
            'label'     => esc_html__('Metric Label Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('light', ['.gc-ppc-metric-label' => 'color: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_light_metric_value_color', [
            'label'     => esc_html__('Metric Value Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('light', ['.gc-ppc-metric-value' => 'color: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_light_chart_bar_odd', [
            'label'     => esc_html__('Chart Bar (Odd)', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('light', ['.gc-email-dashboard-pro-bars span:nth-child(odd)' => 'background: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_light_chart_bar_even', [
            'label'     => esc_html__('Chart Bar (Even)', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('light', ['.gc-email-dashboard-pro-bars span:not(:nth-child(odd))' => 'background: {{VALUE}};']),
        ]);

        $this->add_control('gc_email_hb_light_chart_glow', [
            'label'     => esc_html__('Chart Glow', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('light', ['.gc-email-dashboard-pro-glow' => 'background: radial-gradient(circle at 50% 42%, {{VALUE}} 0%, transparent 70%);']),
        ]);
    ...
    {
        if ('yes' !== ($settings['gc_email_hb_reset_elementor_spacing'] ?? 'yes')) {
            return;
        }
...
?>
    ...
    private function render_chart_bars(array $bars)
    {
        if (empty($bars)) {
            return;
        }
    ?>
        <div class="gc-email-dashboard-pro-visual" aria-hidden="true">
            <div class="gc-email-dashboard-pro-bars">
                <?php foreach ($bars as $bar) :
                    $height = absint($bar['bar_height'] ?? 50);
                    $height = min(100, max(0, $height));
                ?>
                    <span style="--h: <?php echo esc_attr($height); ?>%"></span>
                <?php endforeach; ?>
            </div>
        </div>
    <?php
    ...
    protected function render()
    {
        ...
        $eyebrow              = $settings['gc_email_hb_eyebrow'] ?? '';
        $title                = $settings['gc_email_hb_title'] ?? '';
        $description          = $this->get_paragraph_inner_content($settings['gc_email_hb_description'] ?? '');
        $platforms            = $settings['gc_email_hb_platforms'] ?? [];
        $metrics              = $settings['gc_email_hb_metrics'] ?? [];
        $chart_bars           = $settings['gc_email_hb_chart_bars'] ?? [];
        $primary_button_text  = trim((string) ($settings['gc_email_hb_primary_button_text'] ?? ''));
        $secondary_button_text = trim((string) ($settings['gc_email_hb_secondary_button_text'] ?? ''));
        $dashboard_title      = trim((string) ($settings['gc_email_hb_dashboard_title'] ?? ''));
        $dashboard_status     = trim((string) ($settings['gc_email_hb_dashboard_status'] ?? ''));
        $dashboard_aria       = $settings['gc_email_hb_dashboard_aria_label'] ?? '';
        $platforms_aria       = $settings['gc_email_hb_platforms_aria_label'] ?? '';
        ...
        if (empty($chart_bars)) {
            $chart_bars = $this->get_default_chart_bars();
        }

        $bg_shape_url   = $this->get_media_url($settings['gc_email_hb_bg_shape'] ?? [], $settings['gc_email_hb_bg_shape_fallback'] ?? 'new-update/hero-shape-1.png');
        $shape_1_url    = $this->get_media_url($settings['gc_email_hb_shape_1'] ?? [], $settings['gc_email_hb_shape_1_fallback'] ?? 'new-update/hero-shape-22.png');
        $shape_2_url    = $this->get_media_url($settings['gc_email_hb_shape_2'] ?? [], $settings['gc_email_hb_shape_2_fallback'] ?? 'new-update/hero-shape-3.png');
        $bg_shape_alt   = $settings['gc_email_hb_bg_shape_alt'] ?? '';
        $shape_2_alt    = $settings['gc_email_hb_shape_2_alt'] ?? '';
                ...
                <div class="row align-items-center gc-ppc-roi-row">
                    <div class="col-lg-6">
                        <div class="gc-ppc-hero-content fade-wrapper">
                            ...
                            <?php endif; ?>
                            <?php if ('' !== $description) : ?>
                                <p class="gc-ppc-hero-desc" data-text-animation="fade-in" data-duration="1.4"><?php echo wp_kses($description, ['br' => []]); ?></p>
                            <?php endif; ?>
                            ...
                            <?php if ('' !== $primary_button_text || '' !== $secondary_button_text) : ?>
                                <div class="hero-btn-wrap two gc-ppc-hero-btns">
                                    <?php if ('' !== $primary_button_text) : ?>
                                        <a<?php echo $this->get_link_attributes($settings['gc_email_hb_primary_button_link'] ?? []); ?> class="rr-primary-btn"><?php echo esc_html($primary_button_text); ?></a>
                                        <?php endif; ?>
                                        <?php if ('' !== $secondary_button_text) : ?>
                                            <a<?php echo $this->get_link_attributes($settings['gc_email_hb_secondary_button_link'] ?? []); ?> class="rr-primary-btn gc-hero-btn-outline"><?php echo esc_html($secondary_button_text); ?></a>
                                            <?php endif; ?>
                                </div>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="gc-ppc-dashboard-wrap gc-email-dashboard-pro fade-top">
                            <span class="gc-email-dashboard-pro-glow" aria-hidden="true"></span>
                            <div class="gc-ppc-dashboard-card" data-ppc-dashboard role="img" aria-label="<?php echo esc_attr($dashboard_aria); ?>">
                                ...
                                <?php $this->render_chart_bars($chart_bars); ?>
                                <?php if (!empty($metrics)) : ?>
                                    <div class="gc-ppc-dashboard-metrics gc-email-dashboard-pro-metrics">
...
Plugin::instance()->widgets_manager->register(new Softro_Email_Hero_Banner_Widget());
