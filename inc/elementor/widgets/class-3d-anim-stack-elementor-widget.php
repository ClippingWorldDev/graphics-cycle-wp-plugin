...
class Softro_3D_Anime_Stack_Widget extends Widget_Base
{

    public function get_name()
    {
        return 'gc_3d_anime_stack';
    }

    public function get_title()
    {
        return esc_html__('GC 3D Anim Stack', 'softro-core');
    }
    ...
    {
        $this->start_controls_section('gc_3d_anim_stack_header_section', [
            'label' => esc_html__('Section Header', 'softro-core'),
        ]);

        $this->add_control('gc_3d_anim_stack_show_eyebrow', [
        ...
        $this->add_control('gc_3d_anim_stack_eyebrow', [
            'label'     => esc_html__('Eyebrow', 'softro-core'),
            'type'      => Controls_Manager::TEXT,
            'default'   => esc_html__('Our Stack', 'softro-core'),
            'label_block' => true,
            'condition' => ['gc_3d_anim_stack_show_eyebrow' => 'yes'],
        ]);

        $this->add_control('gc_3d_anim_stack_title_before', [
        ...
        $this->add_control('gc_3d_anim_stack_title_accent', [
        ...
        $this->add_control('gc_3d_anim_stack_intro', [
        ...
        $this->start_controls_section('gc_3d_anim_stack_cards_section', [
            'label' => esc_html__('Stack Cards', 'softro-core'),
        ]);

        $this->add_control('gc_3d_anim_stack_default_logo_icon', [
            'label'   => esc_html__('Default Logo Icon', 'softro-core'),
            'type'    => Controls_Manager::ICONS,
            'default' => ['value' => '', 'library' => 'fa-solid'],
        ]);

        $this->add_control('gc_3d_anim_stack_cards', [
    ...
    {
        $this->start_controls_section('gc_3d_anim_stack_style_layout', [
            'label' => esc_html__('Layout', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_control('gc_3d_anim_stack_reset_elementor_spacing', [
        ...
        $this->add_responsive_control('gc_3d_anim_stack_section_padding_top', [
        ...
        $this->add_responsive_control('gc_3d_anim_stack_section_padding_bottom', [
        ...
        $this->add_responsive_control('gc_3d_anim_stack_section_margin', [
        ...
        $this->add_responsive_control('gc_3d_anim_stack_content_max_width', [
        ...
        $this->start_controls_section('gc_3d_anim_stack_style_section', [
            'label' => esc_html__('Section', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_group_control(Group_Control_Background::get_type(), [
            'name'     => 'gc_3d_anim_stack_section_bg',
            'types'    => ['classic', 'gradient'],
            'selector' => '{{WRAPPER}} .gc-3d-anim-stack',
        ]);

        $this->add_group_control(Group_Control_Background::get_type(), [
            'name'      => 'gc_3d_anim_stack_section_overlay',
            'label'     => esc_html__('Section Overlay', 'softro-core'),
            'types'     => ['classic', 'gradient'],
            'selector'  => '{{WRAPPER}} .gc-3d-anim-stack::before',
        ]);

        $this->add_control('gc_3d_anim_stack_section_border_color', [
        ...
        $this->add_control('gc_3d_anim_stack_rule_heading', [
            'label'     => esc_html__('Decorative Rule', 'softro-core'),
            'type'      => Controls_Manager::HEADING,
            'separator' => 'before',
        ]);

        $this->add_responsive_control('gc_3d_anim_stack_rule_width', [
        ...
        $this->add_responsive_control('gc_3d_anim_stack_rule_height', [
        ...
        $this->add_control('gc_3d_anim_stack_title_heading', [
        ...
        $this->add_control('gc_3d_anim_stack_intro_heading', [
            'label'     => esc_html__('Intro', 'softro-core'),
            'type'      => Controls_Manager::HEADING,
            'separator' => 'before',
        ]);
        ...
        $this->add_group_control(Group_Control_Typography::get_type(), [
            'name'     => 'gc_3d_anim_stack_intro_typography',
            'selector' => '{{WRAPPER}} .gc-3d-anim-stack-intro',
        ]);

        $this->add_control('gc_3d_anim_stack_intro_color', [
            'label'     => esc_html__('Intro Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .gc-3d-anim-stack-intro' => 'color: {{VALUE}};'],
        ]);

        $this->add_responsive_control('gc_3d_anim_stack_intro_margin', [
        ...
        $this->add_responsive_control('gc_3d_anim_stack_content_padding', [
        ...
        $this->start_controls_section('gc_3d_anim_stack_style_grid', [
            'label' => esc_html__('Stack Grid', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_responsive_control('gc_3d_anim_stack_grid_gap', [
        ...
        $this->add_responsive_control('gc_3d_anim_stack_grid_columns', [
        ...
        $this->add_responsive_control('gc_3d_anim_stack_grid_padding', [
        ...
        $this->start_controls_section('gc_3d_anim_stack_style_card', [
            'label' => esc_html__('Stack Card', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_control('gc_3d_anim_stack_card_bg', [
            'label'     => esc_html__('Background', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .gc-3d-anim-stack-card' => 'background-color: {{VALUE}};'],
        ]);

        $this->add_control('gc_3d_anim_stack_card_border_color', [
        ...
        $this->add_group_control(Group_Control_Box_Shadow::get_type(), [
            'name'     => 'gc_3d_anim_stack_card_shadow',
            'selector' => '{{WRAPPER}} .gc-3d-anim-stack-card',
        ]);

        $this->add_responsive_control('gc_3d_anim_stack_card_padding', [
        ...
        $this->add_responsive_control('gc_3d_anim_stack_card_margin', [
        ...
        $this->add_responsive_control('gc_3d_anim_stack_card_radius', [
        ...
        $this->add_responsive_control('gc_3d_anim_stack_card_min_height', [
        ...
        $this->add_responsive_control('gc_3d_anim_stack_card_inner_gap', [
        ...
        $this->add_control('gc_3d_anim_stack_card_hover_heading', [
            'label'     => esc_html__('Hover', 'softro-core'),
            'type'      => Controls_Manager::HEADING,
            'separator' => 'before',
        ]);

        $this->add_control('gc_3d_anim_stack_card_hover_bg', [
            'label'     => esc_html__('Hover Background', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .gc-3d-anim-stack-card:hover' => 'background-color: {{VALUE}};'],
        ]);

        $this->add_control('gc_3d_anim_stack_card_hover_border_color', [
        ...
        $this->add_group_control(Group_Control_Box_Shadow::get_type(), [
            'name'      => 'gc_3d_anim_stack_card_hover_shadow',
        ...
        $this->start_controls_section('gc_3d_anim_stack_style_logo', [
            'label' => esc_html__('Stack Logo', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_responsive_control('gc_3d_anim_stack_logo_width', [
        ...
        $this->add_responsive_control('gc_3d_anim_stack_logo_height', [
        ...
        $this->add_responsive_control('gc_3d_anim_stack_logo_radius', [
            'label'      => esc_html__('Border Radius', 'softro-core'),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%'],
        ...
        $this->add_group_control(Group_Control_Typography::get_type(), [
            'name'     => 'gc_3d_anim_stack_logo_typography',
            'selector' => '{{WRAPPER}} .gc-3d-anim-stack-logo',
        ]);

        $this->add_control('gc_3d_anim_stack_logo_color', [
        ...
        $this->add_responsive_control('gc_3d_anim_stack_logo_icon_size', [
        ...
        $this->add_responsive_control('gc_3d_anim_stack_logo_margin', [
            'label'      => esc_html__('Margin', 'softro-core'),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em'],
        ...
        $this->start_controls_section('gc_3d_anim_stack_style_name', [
            'label' => esc_html__('Stack Name', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_group_control(Group_Control_Typography::get_type(), [
            'name'     => 'gc_3d_anim_stack_name_typography',
            'selector' => '{{WRAPPER}} .gc-3d-anim-stack-name',
        ]);

        $this->add_control('gc_3d_anim_stack_name_color', [
            'label'     => esc_html__('Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .gc-3d-anim-stack-name' => 'color: {{VALUE}};'],
        ]);

        $this->add_responsive_control('gc_3d_anim_stack_name_margin', [
            'label'      => esc_html__('Margin', 'softro-core'),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em'],
    ...
    {
        $this->start_controls_section('gc_3d_anim_stack_style_theme_mode', [
            'label' => esc_html__('Dark / Light Mode Colors', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->start_controls_tabs('gc_3d_anim_stack_theme_mode_tabs');

        $this->start_controls_tab('gc_3d_anim_stack_dark_tab', ['label' => esc_html__('Dark Mode', 'softro-core')]);

        $this->add_group_control(Group_Control_Background::get_type(), [
            'name'      => 'gc_3d_anim_stack_dark_section_bg',
        ...
        $this->add_control('gc_3d_anim_stack_dark_intro_color', [
            'label'     => esc_html__('Intro Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => $this->get_theme_mode_selectors('dark', ['.gc-3d-anim-stack-intro' => 'color: {{VALUE}};']),
        ]);

        $this->add_control('gc_3d_anim_stack_dark_card_bg', [
        ...
        $this->add_control('gc_3d_anim_stack_dark_card_border_color', [
        ...
        $this->add_control('gc_3d_anim_stack_dark_card_hover_bg', [
        ...
        $this->add_control('gc_3d_anim_stack_dark_card_hover_border_color', [
        ...
        $this->add_control('gc_3d_anim_stack_dark_logo_color', [
        ...
        $this->add_control('gc_3d_anim_stack_dark_name_color', [
        ...
        $this->start_controls_tab('gc_3d_anim_stack_light_tab', ['label' => esc_html__('Light Mode', 'softro-core')]);

        $this->add_group_control(Group_Control_Background::get_type(), [
            'name'      => 'gc_3d_anim_stack_light_section_bg',
            'label'     => esc_html__('Section Background', 'softro-core'),
            'types'     => ['classic', 'gradient'],
        ...
        $this->add_control('gc_3d_anim_stack_light_name_color', [
            'label'     => esc_html__('Name Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
    ...
    {
        if ('yes' !== ($settings['gc_3d_anim_stack_reset_elementor_spacing'] ?? 'yes')) {
            return;
        }
    ...
    private function render_stack_logo($card, $settings)
    {
        ...
        if (!empty($card['logo_icon']['value'])) {
            ...
            } elseif (!empty($settings['gc_3d_anim_stack_default_logo_icon']['value'])) {
                $this->render_icon($settings['gc_3d_anim_stack_default_logo_icon'], ['aria-hidden' => 'true']);
            } else {
    ...
    protected function render()
    {
        ...
        $show_eyebrow  = 'yes' === ($settings['gc_3d_anim_stack_show_eyebrow'] ?? 'yes');
        $eyebrow       = $settings['gc_3d_anim_stack_eyebrow'] ?? '';
        $title_before  = $settings['gc_3d_anim_stack_title_before'] ?? '';
        $title_accent  = $settings['gc_3d_anim_stack_title_accent'] ?? '';
        $intro         = $this->get_paragraph_inner_content($settings['gc_3d_anim_stack_intro'] ?? '');
        $cards         = !empty($settings['gc_3d_anim_stack_cards']) ? $settings['gc_3d_anim_stack_cards'] : [];
        ?>
                ...
                <div class="row g-4 g-xl-5 align-items-center gc-3d-anim-stack-row">
                    <div class="col-lg-5">
                        <div class="gc-3d-anim-stack-content">
                            ...
                            <?php if ('' !== $intro) : ?>
                                <p class="gc-3d-anim-stack-intro" data-text-animation="fade-in" data-duration="1.5"><?php echo wp_kses($intro, ['br' => []]); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="col-lg-7">
...
Plugin::instance()->widgets_manager->register(new Softro_3D_Anime_Stack_Widget());
