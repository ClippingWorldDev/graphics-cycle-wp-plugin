...
class Softro_Marketing_Info_Widget extends Widget_Base
{

    public function get_name()
    {
        return 'gc_marketing_info';
    }

    public function get_title()
    {
        return esc_html__('GC Marketing Info', 'softro-core');
    }
    ...
    private function get_default_info_cards()
    {
        $cards = [
            [
                'card_image'     => ['url' => $this->get_theme_img_url('blog/post-15.png')],
                'card_image_alt' => esc_html__('post', 'softro-core'),
                'card_title'     => esc_html__('Transforms Business Operations with Strategic Consulting', 'softro-core'),
            ],
            [
                'card_image'     => ['url' => $this->get_theme_img_url('blog/post-16.png')],
                'card_image_alt' => esc_html__('post', 'softro-core'),
                'card_title'     => esc_html__('Digital Transformation and Creative Brand Strategies', 'softro-core'),
            ],
            [
                'card_image'     => ['url' => $this->get_theme_img_url('blog/post-17.png')],
                'card_image_alt' => esc_html__('post', 'softro-core'),
                'card_title'     => esc_html__('Impactful Branding Strategies for Modern Agencies', 'softro-core'),
            ],
            [
                'card_image'     => ['url' => $this->get_theme_img_url('blog/post-14.jpg')],
                'card_image_alt' => esc_html__('post', 'softro-core'),
                'card_title'     => esc_html__('AI Marketing Trends Shaping Growth in 2026', 'softro-core'),
            ],
        ];

        return array_merge($cards, $cards);
    }
    ...
    {
        $this->start_controls_section('gc_marketing_info_header_section', [
            'label' => esc_html__('Section Header', 'softro-core'),
        ]);

        $this->add_control('gc_marketing_info_title', [
            'label'       => esc_html__('Title', 'softro-core'),
            'type'        => Controls_Manager::TEXT,
            'default'     => esc_html__('Struggling to Get Consistent Results from Digital Marketing?', 'softro-core'),
            'label_block' => true,
        ]);

        $this->add_control('gc_marketing_info_description', [
            'label'   => esc_html__('Description', 'softro-core'),
            'type'    => Controls_Manager::WYSIWYG,
            'default' => esc_html__('Is your marketing budget driving growth, or is it just getting spent? Many businesses invest in digital marketing but struggle to see measurable results and face some common problems.', 'softro-core'),
        ]);
        ...
        $card_repeater->add_control('card_title', [
            ...
            'type'        => Controls_Manager::TEXT,
            'default'     => esc_html__('Transforms Business Operations with Strategic Consulting', 'softro-core'),
            'label_block' => true,
        ]);

        $this->start_controls_section('gc_marketing_info_cards_section', [
            'label' => esc_html__('Info Cards', 'softro-core'),
        ]);

        $this->add_control('gc_marketing_info_cards', [
            'label'       => esc_html__('Cards', 'softro-core'),
            'type'        => Controls_Manager::REPEATER,
            'fields'      => $card_repeater->get_controls(),
            'default'     => $this->get_default_info_cards(),
    ...
    {
        $this->start_controls_section('gc_marketing_info_style_layout', [
            'label' => esc_html__('Layout', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_control('gc_marketing_info_reset_elementor_spacing', [
        ...
        $this->add_responsive_control('gc_marketing_info_section_padding_top', [
        ...
        $this->add_responsive_control('gc_marketing_info_section_padding_bottom', [
        ...
        $this->add_responsive_control('gc_marketing_info_section_margin', [
        ...
        $this->add_responsive_control('gc_marketing_info_row_gap', [
        ...
        $this->start_controls_section('gc_marketing_info_style_header', [
            'label' => esc_html__('Header', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_responsive_control('gc_marketing_info_heading_margin', [
        ...
        $this->add_responsive_control('gc_marketing_info_desc_margin', [
        ...
        $this->start_controls_section('gc_marketing_info_style_card', [
            'label' => esc_html__('Info Card', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_control('gc_marketing_info_card_bg', [
            'label'     => esc_html__('Card Background', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .post-card.card-6.card-8' => 'background-color: {{VALUE}};'],
        ]);

        $this->add_responsive_control('gc_marketing_info_card_padding', [
        ...
        $this->add_responsive_control('gc_marketing_info_card_margin', [
        ...
        $this->add_responsive_control('gc_marketing_info_card_radius', [
        ...
        $this->add_control('gc_marketing_info_card_hover_bg', [
            'label'     => esc_html__('Card Hover Background', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .post-card.card-6.card-8:hover' => 'background-color: {{VALUE}};'],
        ]);

        $this->add_control('gc_marketing_info_thumb_heading', [
            'label'     => esc_html__('Card Image', 'softro-core'),
            'type'      => Controls_Manager::HEADING,
            'separator' => 'before',
        ]);

        $this->add_responsive_control('gc_marketing_info_thumb_height', [
        ...
        $this->add_responsive_control('gc_marketing_info_thumb_width', [
        ...
        $this->add_responsive_control('gc_marketing_info_thumb_radius', [
        ...
        $this->add_responsive_control('gc_marketing_info_thumb_margin', [
        ...
        $this->add_control('gc_marketing_info_card_title_heading', [
            'label'     => esc_html__('Card Title', 'softro-core'),
            'type'      => Controls_Manager::HEADING,
            'separator' => 'before',
        ]);
        ...
        $this->add_group_control(Group_Control_Typography::get_type(), [
            'name'     => 'gc_marketing_info_card_title_typography',
            'selector' => '{{WRAPPER}} .post-card.card-6.card-8 .post-content .title',
        ]);

        $this->add_control('gc_marketing_info_card_title_color', [
            'label'     => esc_html__('Title Color', 'softro-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => ['{{WRAPPER}} .post-card.card-6.card-8 .post-content .title' => 'color: {{VALUE}};'],
        ]);

        $this->add_control('gc_marketing_info_card_title_hover_color', [
        ...
        $this->add_responsive_control('gc_marketing_info_card_title_margin', [
            'label'      => esc_html__('Title Margin', 'softro-core'),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em'],
        ...
        $this->add_responsive_control('gc_marketing_info_card_content_padding', [
    ...
    {
        $this->start_controls_section('gc_marketing_info_style_theme_mode', [
            'label' => esc_html__('Dark / Light Mode Colors', 'softro-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
        ]);

        $this->start_controls_tabs('gc_marketing_info_theme_mode_tabs');

        $this->start_controls_tab('gc_marketing_info_dark_tab', ['label' => esc_html__('Dark Mode', 'softro-core')]);

        $this->add_group_control(Group_Control_Background::get_type(), [
            'name'     => 'gc_marketing_info_dark_section_bg',
        ...
        $this->add_control('gc_marketing_info_dark_card_title_hover_color', [
        ...
        $this->start_controls_tab('gc_marketing_info_light_tab', ['label' => esc_html__('Light Mode', 'softro-core')]);

        $this->add_group_control(Group_Control_Background::get_type(), [
            'name'     => 'gc_marketing_info_light_section_bg',
            'label'    => esc_html__('Section Background', 'softro-core'),
            'types'    => ['classic', 'gradient'],
    ...
    {
        if ('yes' !== ($settings['gc_marketing_info_reset_elementor_spacing'] ?? 'yes')) {
            return;
        }
    ...
    private function render_info_card($card)
    {
    ...
    protected function render()
    {
        ...
        $title       = $settings['gc_marketing_info_title'] ?? '';
        $description = $settings['gc_marketing_info_description'] ?? '';
        $cards       = !empty($settings['gc_marketing_info_cards']) ? $settings['gc_marketing_info_cards'] : [];
        ?>
        ...
        <section class="blog-section-8 pt-130 pb-130 fade-wrapper ai-marketing-blog-section">
            <div class="container">
                <div class="section-heading text-center">
                    ...
                    <?php if ($description) : ?>
                        <p class="ai-marketing-blog-desc"><?php echo $this->get_paragraph_inner_content($description); ?></p>
                    <?php endif; ?>
                </div>
...
Plugin::instance()->widgets_manager->register(new Softro_Marketing_Info_Widget());
