...
if (! class_exists('CSF_Field_link_color')) {
  class CSF_Field_link_color extends CSF_Fields
  {
    ...
    public function render()
    {
      ...
      $color_props = array(
        'color'    => esc_html__('Normal', 'softro-core'),
        'hover'    => esc_html__('Hover', 'softro-core'),
        'active'   => esc_html__('Active', 'softro-core'),
        'visited'  => esc_html__('Visited', 'softro-core'),
        'focus'    => esc_html__('Focus', 'softro-core')
      );
