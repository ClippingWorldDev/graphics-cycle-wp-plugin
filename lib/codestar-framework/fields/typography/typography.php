  ...
  class CSF_Field_typography extends CSF_Fields
  {
    ...
    public function render()
    {
      ...
      if (! empty($args['font_family'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Font Family', 'softro-core') . '</div>';
        echo $this->create_select(array($this->value['font-family'] => $this->value['font-family']), 'font-family', esc_html__('Select a font', 'softro-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['backup_font_family'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Backup Font Family', 'softro-core') . '</div>';
        echo $this->create_select(apply_filters('csf_field_typography_backup_font_family', array(
          ...
          'Georgia, serif',
          'Palatino Linotype'
        )), 'backup-font-family', esc_html__('Default', 'softro-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['font_weight']) || ! empty($args['font_style'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Font Style', 'softro-core') . '</div>';
        echo '<select class="csf--font-style-select" data-placeholder="Default">';
        echo '<option value="">' . (! $this->chosen ? esc_html__('Default', 'softro-core') : '') . '</option>';
        ...
        if (! empty($args['extra_styles'])) {
          ...
          echo (! $this->chosen) ? '<div class="csf--title">' . esc_html__('Load Extra Styles', 'softro-core') . '</div>' : '';
          $placeholder = ($this->chosen) ? esc_html__('Load Extra Styles', 'softro-core') : esc_html__('Default', 'softro-core');
      ...
      if (! empty($args['subset'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Subset', 'softro-core') . '</div>';
        $subset = (is_array($this->value['subset'])) ? $this->value['subset'] : array_filter((array) $this->value['subset']);
        echo $this->create_select($subset, 'subset', esc_html__('Default', 'softro-core'), $args['multi_subset']);
        echo '</div>';
      }
      ...
      if (! empty($args['text_align'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Text Align', 'softro-core') . '</div>';
        echo $this->create_select(array(
          'inherit' => esc_html__('Inherit', 'softro-core'),
          'left'    => esc_html__('Left', 'softro-core'),
          'center'  => esc_html__('Center', 'softro-core'),
          'right'   => esc_html__('Right', 'softro-core'),
          'justify' => esc_html__('Justify', 'softro-core'),
          'initial' => esc_html__('Initial', 'softro-core')
        ), 'text-align', esc_html__('Default', 'softro-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['font_variant'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Font Variant', 'softro-core') . '</div>';
        echo $this->create_select(array(
          'normal'         => esc_html__('Normal', 'softro-core'),
          'small-caps'     => esc_html__('Small Caps', 'softro-core'),
          'all-small-caps' => esc_html__('All Small Caps', 'softro-core')
        ), 'font-variant', esc_html__('Default', 'softro-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['text_transform'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Text Transform', 'softro-core') . '</div>';
        echo $this->create_select(array(
          'none'       => esc_html__('None', 'softro-core'),
          'capitalize' => esc_html__('Capitalize', 'softro-core'),
          'uppercase'  => esc_html__('Uppercase', 'softro-core'),
          'lowercase'  => esc_html__('Lowercase', 'softro-core')
        ), 'text-transform', esc_html__('Default', 'softro-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['text_decoration'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Text Decoration', 'softro-core') . '</div>';
        echo $this->create_select(array(
          'none'               => esc_html__('None', 'softro-core'),
          'underline'          => esc_html__('Solid', 'softro-core'),
          'underline double'   => esc_html__('Double', 'softro-core'),
          'underline dotted'   => esc_html__('Dotted', 'softro-core'),
          'underline dashed'   => esc_html__('Dashed', 'softro-core'),
          'underline wavy'     => esc_html__('Wavy', 'softro-core'),
          'underline overline' => esc_html__('Overline', 'softro-core'),
          'line-through'       => esc_html__('Line-through', 'softro-core')
        ), 'text-decoration', esc_html__('Default', 'softro-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['font_size'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Font Size', 'softro-core') . '</div>';
      ...
      if (! empty($args['line_height'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Line Height', 'softro-core') . '</div>';
        echo '<div class="csf--input-wrap">';
      ...
      if (! empty($args['letter_spacing'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Letter Spacing', 'softro-core') . '</div>';
        echo '<div class="csf--input-wrap">';
      ...
      if (! empty($args['word_spacing'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Word Spacing', 'softro-core') . '</div>';
        echo '<div class="csf--input-wrap">';
      ...
      if (! empty($args['color'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Font Color', 'softro-core') . '</div>';
      ...
      if (! empty($args['custom_style'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Custom Style', 'softro-core') . '</div>';
    ...
    public function enqueue()
    {
      ...
      if (! wp_script_is('csf-webfontloader')) {
        ...
        wp_enqueue_script('csf-webfontloader', 'https://cdn.jsdelivr.net/npm/webfontloader@1.6.28/webfontloader.min.js', array('softro-core'), '1.6.28', true);
        ...
        if (! empty($customwebfonts)) {
          $webfonts['custom'] = array(
            'label' => esc_html__('Custom Web Fonts', 'softro-core'),
            'fonts' => $customwebfonts
          );
        }

        $webfonts['safe'] = array(
          'label' => esc_html__('Safe Web Fonts', 'softro-core'),
          'fonts' => apply_filters(
        ...
        $webfonts['google'] = array(
          'label' => esc_html__('Google Web Fonts', 'softro-core'),
          'fonts' => apply_filters(
        ...
        wp_localize_script('softro-core', 'csf_typography_json', array(
          'webfonts'      => $webfonts,
