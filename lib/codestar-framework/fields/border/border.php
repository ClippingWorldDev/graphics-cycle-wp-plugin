  ...
  class CSF_Field_border extends CSF_Fields
  {
    ...
    public function render()
    {
      ...
      $args = wp_parse_args($this->field, array(
        ...
        'top_placeholder'    => esc_html__('top', 'softro-core'),
        'right_placeholder'  => esc_html__('right', 'softro-core'),
        'bottom_placeholder' => esc_html__('bottom', 'softro-core'),
        'left_placeholder'   => esc_html__('left', 'softro-core'),
        'all_placeholder'    => esc_html__('all', 'softro-core'),
        'top'                => true,
        'left'               => true,
        'bottom'             => true,
        'right'              => true,
      ...
      $border_props = array(
        'solid'     => esc_html__('Solid', 'softro-core'),
        'dashed'    => esc_html__('Dashed', 'softro-core'),
        'dotted'    => esc_html__('Dotted', 'softro-core'),
        'double'    => esc_html__('Double', 'softro-core'),
        'inset'     => esc_html__('Inset', 'softro-core'),
        'outset'    => esc_html__('Outset', 'softro-core'),
        'groove'    => esc_html__('Groove', 'softro-core'),
        'ridge'     => esc_html__('ridge', 'softro-core'),
